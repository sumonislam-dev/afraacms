                        ...
                        <dl class="mt-4 space-y-2 text-sm text-gray-700">
                            ...
                            @if ($certificate->enrollment)
                                ...
                                @if ($certificate->enrollment->grade)
                                    <div class="flex justify-between gap-4"><dt class="text-gray-500">{{ __('Grade') }}</dt><dd class="font-medium text-gray-900">{{ $certificate->enrollment->grade }}</dd></div>
                                @endif
                                @if ($certificate->enrollment->completion_date)
                                    <div class="flex justify-between gap-4"><dt class="text-gray-500">{{ __('Completed') }}</dt><dd class="font-medium text-gray-900">{{ $certificate->enrollment->completion_date->format('F j, Y') }}</dd></div>
                                @endif
                            @else
