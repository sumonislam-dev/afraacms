        ...
        @foreach ($items as $item)
            <li class="group relative">
                <a
                    ...
                    class="flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-white/80 transition hover:text-white"
                >
                    @if ($item['icon'])
            ...
            <li>
                <a
                    ...
                    @class([
                        ...
                        'text-white/80 hover:bg-white/10 hover:text-white' => $dark,
                        'text-ink-800 hover:bg-brand-50 hover:text-brand-600' => ! $dark,
                    ])
