    ...
    >
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
                ...
                />
                <p class="mt-1 text-xs text-gray-500">{{ __('Public URL, e.g. /projects/new-office-tower') }}</p>
        ...
        <div>
            ...
            <p class="mt-1 text-xs text-gray-500">{{ __('Short summary shown on the projects listing.') }}</p>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500">{{ __('Featured projects are listed first on the public site.') }}</p>
